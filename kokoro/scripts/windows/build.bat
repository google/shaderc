...
set VS_VERSION=%2
set ARCH=%3
:: SHADERC_ENABLE_HLSL=ON or SHADERC_ENABLE_HLSL=OFF
set SHADERC_ENABLE_HLSL=%4
...
set CMAKE_FLAGS=-DCMAKE_INSTALL_PREFIX=%KOKORO_ARTIFACTS_DIR%\install -DRE2_BUILD_TESTING=OFF -GNinja -DCMAKE_BUILD_TYPE=%BUILD_TYPE% -DCMAKE_C_COMPILER=cl.exe -DCMAKE_CXX_COMPILER=cl.exe -DSHADERC_ENABLE_HLSL=%SHADERC_ENABLE_HLSL%
