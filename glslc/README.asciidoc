...
GLSL, e.g., `450`.  The OpenGL 'compatibility' profile is not supported and will result
in an error.
...
The OpenGL compatibility profile, specified by a value of `opengl_compat` is *not* supported,
